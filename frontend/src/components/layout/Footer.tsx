      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-6 md:mb-0">
            <Link href="/" className="text-2xl font-bold">
              <span className="text-blue-500">Escola</span> PAZ e BEM
            </Link>
            <p className="mt-2 text-gray-400">Fortalecendo vidas através do ensino bíblico.</p>
          </div>
          ...
          <div className="flex space-x-6">
            ...
            <a 
              href="https://twitter.com/escolapazebem" 
              target="_blank" 
              rel="noopener noreferrer"
              className="text-gray-400 hover:text-white transition"
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-500 text-sm">
          ...
          <div className="mt-2 flex justify-center space-x-6">
            <Link href="/privacy-policy" className="hover:text-white transition">Política de Privacidade</Link>
